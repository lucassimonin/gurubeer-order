 ...
 */
final class Version20190202143710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE gurubeer_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, file_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, created DATETIME NOT NULL, updated DATETIME NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gurubeer_order_version AS SELECT id, order_id, creator_id, state, created, updated FROM gurubeer_order_version');
        $this->addSql('DROP TABLE gurubeer_order_version');
        $this->addSql('CREATE TABLE gurubeer_order_version (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, order_id INTEGER DEFAULT NULL, creator_id INTEGER DEFAULT NULL, state VARCHAR(255) NOT NULL COLLATE BINARY, created DATETIME NOT NULL, updated DATETIME NOT NULL, version INTEGER NOT NULL, CONSTRAINT FK_D69CA2E08D9F6D38 FOREIGN KEY (order_id) REFERENCES gurubeer_order (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D69CA2E061220EA6 FOREIGN KEY (creator_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO gurubeer_order_version (id, order_id, creator_id, state, created, updated) SELECT id, order_id, creator_id, state, created, updated FROM __temp__gurubeer_order_version');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ext_log_entries AS SELECT id, "action", logged_at, object_id, object_class, version, username, data FROM ext_log_entries');
        ...
        $this->addSql('INSERT INTO ext_log_entries (id, "action", logged_at, object_id, object_class, version, username, data) SELECT id, "action", logged_at, object_id, object_class, version, username, data FROM __temp__ext_log_entries');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gurubeer_order AS SELECT id, name, file_name, created, updated FROM gurubeer_order');
        $this->addSql('DROP TABLE gurubeer_order');
        $this->addSql('CREATE TABLE gurubeer_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, file_name VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, creator_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO gurubeer_order (id, name, file_name, created, updated) SELECT id, name, file_name, created, updated FROM __temp__gurubeer_order');
        $this->addSql('DROP TABLE __temp__gurubeer_order');
